...
import { deleteChat, renameChat } from "@/app/lib/lpmsApi";
import { ProjectAssistantTable } from "@/components/lpms/matters/ProjectAssistantTable";
import {
    ProjectSectionToolbar,
    useProjectWorkspace,
} from "@/components/lpms/matters/ProjectWorkspace";
import type { Chat } from "@/components/lpms/shared/types";
...
export default function MatterAssistantPage({ params }: Props) {
    use(params);

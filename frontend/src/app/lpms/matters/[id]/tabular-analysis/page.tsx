...
import { ProjectReviewsTable } from "@/components/lpms/matters/ProjectReviewsTable";
import {
    ProjectSectionToolbar,
    useProjectWorkspace,
} from "@/components/lpms/matters/ProjectWorkspace";
import type { TabularReview } from "@/components/lpms/shared/types";
...
export default function MatterTabularListPage({ params }: Props) {
    use(params);
        ...
        <>
            ...
            <ProjectReviewsTable
                ...
                onOpenReview={(reviewId) =>
                    router.push(
                        `/lpms/matters/${projectId}/tabular-analysis/${reviewId}`,
                    )
                }

...
function DocumentsContent() {
  ...
  const setTab = (tab: "mine" | "shared") => {
    router.replace(tab === "mine" ? "/clm/documents" : "/documents?tab=shared")
  }
                  ...
                  mineDocs.map((doc) => (
                    <TableRow key={doc.id}>
                      <TableCell className="font-medium">
                        <Link href={`/clm/editor/${doc.id}`} className="flex items-center gap-2 hover:underline">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem asChild>
                              <Link href={`/clm/editor/${doc.id}`}>{t("recent_docs_open")}</Link>
                            </DropdownMenuItem>

    ...
    return (
        <>
            <div className="w-full">
                <div className="rounded-xl border border-input bg-background shadow-sm overflow-hidden focus-within:ring-1 focus-within:ring-ring">
                    {/* Attached chips */}
                    ...
                    <div className="px-4 pt-4">
                        <textarea
                            ...
                            className="w-full resize-none overflow-hidden border-0 text-sm p-0 bg-transparent outline-none placeholder:text-muted-foreground leading-6 max-h-48"
                        />
                    </div>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button
                                type="button"
                                className={cn(
                                    "relative bg-primary text-primary-foreground rounded-md h-8 w-8 flex items-center justify-center cursor-pointer hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50 transition-colors",
                                )}

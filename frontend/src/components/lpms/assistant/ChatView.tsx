                    ...
                    >
                        <button
                            ...
                            className={cn(
                                ...
                                "bg-background border border-input shadow-md hover:bg-muted text-muted-foreground",
                            )}
                        >
                ...
                >
                    <div
                        className={cn(
                            ...
                            "right-0 h-28 bg-gradient-to-t from-background via-background/80 to-transparent",
                        )}
                    />

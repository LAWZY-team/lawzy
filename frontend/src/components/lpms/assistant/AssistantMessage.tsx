...
const RESPONSE_GLASS_ANNOTATION =
    "inline-flex h-4 w-4 items-center justify-center rounded-full border border-border bg-muted text-[12px] font-serif font-medium text-muted-foreground shadow-sm transition-colors hover:bg-secondary hover:text-secondary-foreground";
...
function ResponseStatus({ status }: { status: StatusState }) {
    ...
    return (
        <div className="w-full h-9 flex items-center gap-2 mb-2">
            <img src="/logo/lawzy-triangle.png" alt="Lawzy Logo" className="h-6 w-auto object-contain" />
            <span className="font-serif font-semibold text-gray-900 text-sm">Lawzy</span>
            {isActive && (

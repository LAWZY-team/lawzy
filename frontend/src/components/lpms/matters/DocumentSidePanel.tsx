...
import { DocView } from "@/components/lpms/shared/DocView";
import { WarningPopup } from "@/components/lpms/shared/WarningPopup";
import type { Document } from "@/components/lpms/shared/types";
import type { DocumentVersion } from "@/app/lib/lpmsApi";
...
function versionFilenameFor(version: DocumentVersion) {
    ...
    return version.source === "upload" ? "Original" : "â€”";
}

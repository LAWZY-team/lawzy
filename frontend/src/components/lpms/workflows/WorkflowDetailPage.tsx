...
import { deleteWorkflow, getWorkflow, updateWorkflow } from "@/app/lib/lpmsApi";
import { ShareWorkflowModal } from "@/components/lpms/workflows/ShareWorkflowModal";
import { WFEditColumnModal } from "@/components/lpms/workflows/WFEditColumnModal";
import { WFColumnViewModal } from "@/components/lpms/workflows/WFColumnViewModal";
...
import { WorkflowDetailsModal } from "@/components/lpms/workflows/WorkflowDetailsModal";
import { useAuth } from "@/contexts/AuthContext";
import { useUserProfile } from "@/contexts/UserProfileContext";
// dynamic import keeps Tiptap (browser-only) out of the SSR bundle
const WorkflowPromptEditor = dynamic(
    () =>
        import("@/components/lpms/workflows/WorkflowPromptEditor").then(

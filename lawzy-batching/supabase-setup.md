npm install @supabase/supabase-js @supabase/ssr (already installed)
File .env.local:
NEXT_PUBLIC_SUPABASE_URL=already got
NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY=already got
...
## 2. File: utils/supabase/server.ts
...
## 3. File: utils/supabase/client.ts
...
## 4. File: utils/supabase/middleware.ts
